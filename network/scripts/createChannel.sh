...
joinChannel() {
    ...
    docker exec -e CORE_PEER_MSPCONFIGPATH=${CORE_PEER_MSPCONFIGPATH} -e CORE_PEER_ADDRESS=${CORE_PEER_ADDRESS} -e CORE_PEER_LOCALMSPID=${CORE_PEER_LOCALMSPID} -e CORE_PEER_TLS_ROOTCERT_FILE=${CORE_PEER_TLS_ROOTCERT_FILE} -e CORE_PEER_TLS_CERT_FILE=${CORE_PEER_TLS_CERT_FILE} -e CORE_PEER_TLS_KEY_FILE=${CORE_PEER_TLS_KEY_FILE} cli peer channel join -b $BLOCK_PATH
